...
export default {
  darkMode: "class", // importante para usar .dark en el <html> o <body>
  ...
  theme: {
    extend: {
      // Colores principales del design system + paletas que ya tenías
      colors: {
        // Paleta PRIMARY (la que ya tenías)
        primary: {
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
        ...
        // Paleta SECONDARY (la que ya tenías)
        secondary: {
          50: '#f8fafc',
          100: '#f1f5f9',
          200: '#e2e8f0',
        ...
        // 🔽 Mapeos a las CSS variables de globals.css
